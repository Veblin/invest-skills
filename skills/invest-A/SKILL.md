...
argument-hint: "/invest-A 600176 | /invest-A 600176 --deep | /invest-A 600176 --intent game_theory"
...
uv run python skills/invest-A/scripts/invest.py plan 600176 --intent game_theory

# 按计划采集 + 证据表 + 报告
uv run python skills/invest-A/scripts/invest.py collect 600176 --plan /tmp/plan.json
uv run python skills/invest-A/scripts/invest.py evidence 600176 --plan /tmp/plan.json
uv run python skills/invest-A/scripts/invest.py report 600176 --plan /tmp/plan.json --mode full

...
> **Canonical 源**：[report-conventions.md §3](skills/lib/references/report-conventions.md)（禁止词替换表 + 已知违规模式 17 条 + 事实边界 §2.3）。此处仅列最高频约束，完整表在发出报告前须逐一核对：

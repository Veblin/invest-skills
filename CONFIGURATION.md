...
```bash
npx skills add Veblin/invest-skills --skill invest-A -g -a cursor -y
```

### OpenClaw

```bash
npx skills add Veblin/invest-skills --skill invest-A -g -a openclaw -y
# 或（已 clone 本仓库时）
...
```bash
npx skills add Veblin/invest-skills --skill invest-A -g -y
